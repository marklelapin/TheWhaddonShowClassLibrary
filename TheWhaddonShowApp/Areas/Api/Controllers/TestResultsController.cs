...
namespace TheWhaddonShowApp.Areas.Api.Controllers
{
	...
	public class TestResultsController : Controller
	{
		...
		public async Task<IActionResult> Filtered(Guid testOrCollectionId, DateTime? dateFrom = null, DateTime? dateTo = null, int skip = 0, int limit = 1000)
		{
		...
		private async Task<TestResultsModel> GetTestResultsModel(Guid testOrCollectionId, DateTime? dateFrom = null, DateTime? dateTo = null, int skip = 0, int limit = 1000)
		{
