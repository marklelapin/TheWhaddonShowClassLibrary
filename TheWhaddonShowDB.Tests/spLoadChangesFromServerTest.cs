...
namespace TheWhaddonShowDB.Tests
{
    [TestClass()]
    public class spLoadChangesFromServer : SqlDatabaseTestClass
    {

        public spLoadChangesFromServer()
        {
            InitializeComponent();
        }
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(spLoadChangesFromServer));
            ...
            // 
            dbo_spLoadChangesFromServerTest_TestAction.Conditions.Add(rowCountCondition1);
